...
<head>
    ...
    <title>Admin Dashboard | Visitors Pass System</title>
...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
        ...
        <a class="navbar-brand mr-1" href="home.php"><img src="../images/qr_code_1.png" class="image image-responsive"
                height="45" width="45"> Visitors Pass System</a>
        ...
        <form class="d-none d-md-inline-block form-inline ml-auto mr-0 mr-md-3 my-2 my-md-0">
            <div class="input-group" style="visibility: hidden;">
                <input type="text" class="form-control" disabled placeholder="Search for..." aria-label="Search"
                    ...
                    <div class="col-xl-3 col-sm-6 mb-3">
                        <div class="card text-white bg-primary o-hidden h-100">
                            <div class="card-body">
                                ...
                                <div class="mr-5"><?php echo $admin; ?>
                                    <?php if ($admin == 1) { echo "Admin"; } else { echo "Admins"; } ?></div>
                            </div>
                    ...
                    <div class="col-xl-3 col-sm-6 mb-3">
                        <div class="card text-white bg-warning o-hidden h-100">
                            <div class="card-body">
                                ...
                                <div class="mr-5"><?php echo $regular; ?>
                                    <?php if ($regular == 1) { echo "Regular Visitors"; } else { echo "Regular Visitors"; } ?>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-3 col-sm-6 mb-3">
                        <div class="card text-white bg-danger o-hidden h-100">
                            <div class="card-body">
                                ...
                                <div class="mr-5"><?php echo $restricted; ?>
                                    <?php if ($restricted == 1) { echo "Restricted Visitors"; } else { echo "Restricted Visitors"; } ?>
                                </div>
                            </div>
...
?>
                                    <tr>
                                        ...
                                        <td style="vertical-align: middle;"> <?php echo $user['emergency_person']; ?>
                                        </td>
                                        <td style="vertical-align: middle;"> <?php echo $user['emergency_phone_no']; ?>
                                        </td>
                                        <td style="vertical-align: middle;">
                                            <?php echo date('h:i A', strtotime($user['start_time'])); ?> </td>
                                        <td style="vertical-align: middle;">
                                            <?php echo date('h:i A', strtotime($user['end_time'])); ?> </td>
                                        <td style="vertical-align: middle;"> <?php echo $user['access']; ?> </td>
                                        <td style="vertical-align: middle; text-align: justify;">
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                <button
                                                    onclick="location.href='edit-user.php?i=<?php echo base64_encode($user['uid']); ?>'"
                                                    class="btn btn-primary" style="width: 40px;"><i
                                                        class="fas fa-edit text-white"></i></button>
                                                <?php
    if ($user['access'] != "admin") {
?>
                                                <button
                                                    onclick="location.href='attendance-details.php?i=<?php echo base64_encode($user['uid']); ?>'"
                                                    class="btn btn-warning" style="width: 40px;"><i
                                                        class="fas fa-info text-white"></i></button>
                                                <?php
    }
?>
                                                <button
                                                    onclick="if(confirm('Are you sure you want to delete? This action cannot be undone.')) { location.href='delete.php?i=<?php echo $user['uid']; ?>'; }"
                                                    class="btn btn-danger" style="width: 40px;"><i
...
?>
      ...
      <footer class="sticky-footer">
        <div class="container my-auto">
          ...
          <span>Copyright © Visitors Pass System 2023</span>
          </div>
        </div>
      </footer>
