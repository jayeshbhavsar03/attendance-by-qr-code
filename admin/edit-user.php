...
<head>
  ...
  <title>Add User | Visitors Pass System</title>
...
?>
  <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
    ...
    <a class="navbar-brand mr-1" href="home.php"><img src="../images/qr_code_1.png" class="image image-responsive" height="45" width="45"> Visitors Pass System</a>
              ...
              <div class="form-row">
                ...
                <div class="form-group col-md-8">
                  ...
                  <select name="user_group" id="userGroup" class="form-control" required>
                    ...
                    <option  <?php if ($user['access'] == "regular") { echo "selected"; } ?> value="regular visitors">Regular Visitors</option>
                    <option  <?php if ($user['access'] == "restricted") { echo "selected"; } ?> value="restricted visitors">Restricted Visitors</option>
                  </select>
                </div>
              </div>
