...
<head>
  ...
  <title>Login | Visitor Pass System</title>
...
?>
  <div class="container">
    <div class="card card-login mx-auto mt-5" style="background: rgba(0,0,0,0.7); border-radius: 0;">
      <div class="card-body">
        <center><img src="images/login_logo.png" class="image image-responsive" height="150" width="150"></center>
        <br />
        <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
          <div class="form-group">
            <div class="form-label-group">
              <input type="text" style="border-radius: 0;" id="inputEmail" name="username" class="form-control" placeholder="Username" required="required" autofocus="autofocus">
              <label for="inputEmail">Username</label>
            </div>
          </div>
          <div class="form-group">
            <div class="form-label-group">
              <input type="password" style="border-radius: 0;" id="inputPassword" name="password" class="form-control" placeholder="Password" required="required">
              <label for="inputPassword">Password</label>
            </div>
          </div>
          <button type="submit" style="border-radius: 0;" name="submit" class="btn btn-primary btn-block">Login</button>
        </form>
      </div>
    </div>
  </div>
